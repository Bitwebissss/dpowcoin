...
static RPCHelpMan waitforblock()
{
    return RPCHelpMan{
        ...
        "Waits for a specific new block and returns useful info about it.\n"
                ...
                RPCExamples{
                    HelpExampleCli("waitforblock", "\"d86f8a0582e779830f182befeaaabc8c73a159b6b06530910758daf17ce31e36\" 1000")
            + HelpExampleRpc("waitforblock", "\"d86f8a0582e779830f182befeaaabc8c73a159b6b06530910758daf17ce31e36\", 1000")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    int timeout = 0;
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (dpowcoin-cli -rpcclienttimeout=0)",
        {
        ...
        RPCExamples{
            HelpExampleCli("getdescriptoractivity", "'[\"20541814e32643230b7aeca8f004f5cf696eeb1bf7155134c2392b001d8c53b0\"]' '[\"addr(dpc1qs2qa5q7sgu6henmazpxk6h2k4e47kqr774wh2w)\"]'")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    UniValue ret(UniValue::VOBJ);
...
void RegisterBlockchainRPCCommands(CRPCTable& t)
{
    static const CRPCCommand commands[]{
        ...
        {"blockchain", &getargon2idpowblockhash}, /* Dpowcoin Params */
