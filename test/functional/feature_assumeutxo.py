...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_invalid_snapshot_scenarios(self, valid_snapshot_path):
        ...
        for content, offset, wrong_hash, custom_message in cases:
            ...
            msg = custom_message if custom_message is not None else f"Bad snapshot content hash: expected 77874d48d932a5cb7a7f770696f5224ff05746fdcf732a58270b45da0f665934, got {wrong_hash}."
            expected_error(msg)

    def test_headers_not_synced(self, valid_snapshot_path):
        for node in self.nodes[1:]:
            msg = "Unable to load UTXO snapshot: The base block header (c8ed3bb3540dd69c0f5caef1f037e59f8e7b5c3e6edba2ae006c6b8e609d90b5) must appear in the headers chain. Make sure all headers are syncing, and call loadtxoutset again."
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test dpowcoind should fail when mempool not empty.")
        node=self.nodes[2]
    ...
    def test_invalid_file_path(self):
        self.log.info("Test dpowcoind should fail when file path is invalid.")
        node = self.nodes[0]
    ...
    def test_snapshot_with_less_work(self, dump_output_path):
        self.log.info("Test dpowcoind should fail when snapshot has less accumulated work than this node.")
        node = self.nodes[0]
    ...
    def test_snapshot_block_invalidated(self, dump_output_path):
        ...
        for height in [SNAPSHOT_BASE_HEIGHT, SNAPSHOT_BASE_HEIGHT - 1]:
            ...
            msg = "Unable to load UTXO snapshot: The base block header (77874d48d932a5cb7a7f770696f5224ff05746fdcf732a58270b45da0f665934) is part of an invalid chain."
            assert_raises_rpc_error(-32603, msg, node.loadtxoutset, dump_output_path)
    ...
    def run_test(self):
        ...
        def check_dump_output(output):
            assert_equal(
                ...
                "77874d48d932a5cb7a7f770696f5224ff05746fdcf732a58270b45da0f665934")
